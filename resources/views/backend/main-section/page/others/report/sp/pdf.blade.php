...
<div style="position:absolute;top:0.40in;left:4.90in;width:2.30in;line-height:0.23in;"><span style="font-style:normal;font-weight:normal;font-size:15pt;font-family:Segoe UI;color:#ff1100">Supplier Stock Report</span><span style="font-style:normal;font-weight:normal;font-size:17pt;font-family:Segoe UI;color:#212529"> </span><br/></SPAN></div>
<div style="position:absolute;top:0.70in;left:4.70in;width:2.30in;line-height:0.23in;"><span style="font-style:normal;font-weight:normal;font-size:13pt;font-family:Segoe UI;color:#212529"></span>Supplier : {{$allData['0']['supplier']['name']}}<span style="font-style:normal;font-weight:normal;font-size:17pt;font-family:Segoe UI;color:#212529"> </span><br/></SPAN></div>
...
<br/><br/><br/><br/><br/><br/><br/><br/><br/>
        ...
        <tbody>
		  ...
		  @php
		  $buying_total = App\Models\Others\Purchase\Purchase::where('category_id',$details->category_id)->where('product_id',$details->id)->where('status','1')->sum('buying_qty');
		  $selling_total = App\Models\Others\Invoice\InvoiceDetail::where('category_id',$details->category_id)->where('product_id',$details->id)->where('status','1')->sum('selling_qty');
		  @endphp
		  <tr>
            <td>#{{$key+1}}</td>
            <td>{{$details->name}}</td>
			...
			<td>{{$buying_total}}</td>
			<td>{{$selling_total}}</td>
            <td>{{$details->quantity}} {{$details['unit']['name']}}</td>
		  </tr>
		  @endforeach
        </tbody>
  </table>
